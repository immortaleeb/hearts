...
public class RegularRound3Scenario extends FixedRoundScenario {

    private final GameId gameId;
    private final List<PlayerId> players;

    public RegularRound3Scenario(GameId gameId, List<PlayerId> players) {
        this.gameId = gameId;
    ...
    public PassedCards cardsPassed() {
        return PassedCards.none()
            .pass(players.get(0), players.get(2), CardFixtures.threeCardsOfSuite(Suite.HEARTS))
            .pass(players.get(1), players.get(3), CardFixtures.threeCardsOfSuite(Suite.CLUBS))
            .pass(players.get(2), players.get(0), CardFixtures.threeCardsOfSuite(Suite.DIAMONDS))
            .pass(players.get(3), players.get(1), CardFixtures.threeCardsOfSuite(Suite.SPADES));
    }
    ...
    public Map<PlayerId, Integer> roundScore() {
        return new HashMap<>() {{
            put(players.get(0), 0);
            put(players.get(1), 11);
            put(players.get(2), 0);
            put(players.get(3), 15);
        }};
    }
    ...
    protected Trick trick1() {
        return new Trick(
            List.of(
                ...
                new CardPlayed(gameId, players.get(3), Card.of(Suite.CLUBS, Rank.ACE), players.get(0), emptyList()),
                new CardPlayed(gameId, players.get(0), Card.of(Suite.DIAMONDS, Rank.ACE), players.get(1), emptyList())
            ),
            new TrickWon(gameId, players.get(3))
        );
    }
    ...
    protected Trick trick2() {
        return new Trick(
            List.of(
                new CardPlayed(gameId, players.get(3), Card.of(Suite.CLUBS, Rank.JACK), players.get(0), emptyList()),
                new CardPlayed(gameId, players.get(0), Card.of(Suite.DIAMONDS, Rank.JACK), players.get(1), emptyList()),
                new CardPlayed(gameId, players.get(1), Card.of(Suite.CLUBS, Rank.KING), players.get(2), emptyList()),
                new CardPlayed(gameId, players.get(2), Card.of(Suite.HEARTS, Rank.JACK), players.get(3), emptyList())
            ),
    ...
    protected Trick trick3() {
        return new Trick(
            List.of(
                new CardPlayed(gameId, players.get(1), Card.of(Suite.SPADES, Rank.ACE), players.get(2), emptyList()),
                new CardPlayed(gameId, players.get(2), Card.of(Suite.HEARTS, Rank.ACE), players.get(3), emptyList()),
    ...
    protected Trick trick4() {
        return new Trick(
            List.of(
                new CardPlayed(gameId, players.get(1), Card.of(Suite.SPADES, Rank.TEN), players.get(2), emptyList()),
                new CardPlayed(gameId, players.get(2), Card.of(Suite.HEARTS, Rank.TEN), players.get(3), emptyList()),
                new CardPlayed(gameId, players.get(3), Card.of(Suite.SPADES, Rank.QUEEN), players.get(0), emptyList()),
                new CardPlayed(gameId, players.get(0), Card.of(Suite.DIAMONDS, Rank.TEN), players.get(1), emptyList())
            ),
            new TrickWon(gameId, players.get(3))
        );
    ...
    protected Trick trick5() {
        return new Trick(
            List.of(
                ...
                new CardPlayed(gameId, players.get(1), Card.of(Suite.SPADES, Rank.JACK), players.get(2), emptyList()),
    ...
    protected Trick trick6() {
        return new Trick(
            List.of(
                new CardPlayed(gameId, players.get(3), Card.of(Suite.CLUBS, Rank.TEN), players.get(0), emptyList()),
