...
public class ShootForTheMoonRound1Scenario extends FixedRoundScenario {
    ...
    public PassedCards cardsPassed() {
        return PassedCards.none()
            .pass(players.get(0), players.get(1), CardFixtures.threeCardsOfSuite(Suite.HEARTS))
            .pass(players.get(1), players.get(2), CardFixtures.threeCardsOfSuite(Suite.CLUBS))
            .pass(players.get(2), players.get(3), CardFixtures.threeCardsOfSuite(Suite.DIAMONDS))
            .pass(players.get(3), players.get(0), CardFixtures.threeCardsOfSuite(Suite.SPADES));
    }
    ...
    protected Trick trick13() {
        return new Trick(
            List.of(
                ...
                new CardPlayed(players.get(0), Card.of(Suite.HEARTS, Rank.TWO), null, emptyList())
            ),
            new TrickWon(players.get(1))
        );
    }
