...
class ListLobbiesHandlerTest {
    ...
    void list_lobbies_returns_all_stored_lobbies() {
        ...
        repository.givenExisting(new Lobby.Snapshot(lobbyId1, "Lobby 1", player1, List.of(player1)));
        repository.givenExisting(new Lobby.Snapshot(lobbyId2, "Lobby 2", player2, List.of(player2)));
        repository.givenExisting(new Lobby.Snapshot(lobbyId3, "Lobby 3", player3, List.of(player3)));
