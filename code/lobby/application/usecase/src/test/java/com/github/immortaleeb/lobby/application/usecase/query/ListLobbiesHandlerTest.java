...
class ListLobbiesHandlerTest {
    ...
    void list_lobbies_returns_all_stored_lobbies() {
        ...
        repository.givenExisting(new Lobby.Snapshot(lobbyId1, WAITING_FOR_PLAYERS, "Lobby 1", player1, List.of(player1), null));
        repository.givenExisting(new Lobby.Snapshot(lobbyId2, WAITING_FOR_PLAYERS, "Lobby 2", player2, List.of(player2), null));
        repository.givenExisting(new Lobby.Snapshot(lobbyId3, WAITING_FOR_PLAYERS, "Lobby 3", player3, List.of(player3), null));
