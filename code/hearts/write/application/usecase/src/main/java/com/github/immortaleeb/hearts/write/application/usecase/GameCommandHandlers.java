...
public class GameCommandHandlers {
    ...
    public static void registerAll(CommandHandlerRegistry commandHandlerRegistry, GameRepository gameRepository, GameSummaryWriteRepository gameSummaryWriteRepository) {
        ...
        commandHandlerRegistry.register(ProjectGameEvent.class, new ProjectGameEventHandler(gameSummaryWriteRepository));
    }
