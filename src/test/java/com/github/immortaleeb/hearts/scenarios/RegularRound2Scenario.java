...
public class RegularRound2Scenario extends FixedRoundScenario {
    ...
    public PassedCards cardsPassed() {
        return PassedCards.none()
            .pass(players.get(0), players.get(3), threeCardsOfSuite(Suite.HEARTS))
            .pass(players.get(1), players.get(0), threeCardsOfSuite(Suite.CLUBS))
            .pass(players.get(2), players.get(1), threeCardsOfSuite(Suite.DIAMONDS))
            .pass(players.get(3), players.get(2), threeCardsOfSuite(Suite.SPADES));
    }
